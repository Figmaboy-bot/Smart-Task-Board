...
// Single shared instance so every page and the Header read and mutate the
// same live task list, instead of each mounting its own disconnected copy
// (which made things like notification badges go stale immediately).
